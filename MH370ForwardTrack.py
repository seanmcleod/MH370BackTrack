...
filterUsingDoppler = False
pingRingDiffError = 0.04
dopplerDiffError = 0.29
bearingIncrement = 1
startingIncrement = 1
...
pingCircle = Circle((satelliteInfo1940['LatLon'][1],satelliteInfo1940['LatLon'][0]), radius=30.5, fill=False)
...
plt.savefig("MH370 Forwardtrack2 - %dkt - Doppler Filter - %s.png" % (aircraftGroundSpeed, dopplerError))
